...
export const APP_CONFIG = {
  ...
  api: {
    baseUrl: getApiBaseUrl(), // Detecta automáticamente HTTP/HTTPS
    timeout: 30000,
  },
  upload: {
...
export const ERROR_MESSAGES = {
  ...
  [ERROR_CODES.PROCESSING_FAILED]: 'Error al procesar la imagen. Por favor, inténtalo de nuevo',
  [ERROR_CODES.NETWORK_ERROR]: 'Error de conexión. Verifica tu conexión a internet',
  [ERROR_CODES.CONNECTION_FAILED]: 'No se pudo conectar con el servidor. Verifica que el backend esté corriendo',
  [ERROR_CODES.TIMEOUT]: 'El servidor tardó demasiado en responder. Por favor, inténtalo de nuevo'
}
...
export const SKIN_LESION_TYPES = {
  ...
  scc: {
    ...
    fullName: 'Carcinoma de Células Escamosas',
    type: 'Maligno',
    isCancer: true,
    severity: 'high',
    icon: '🔴',
    description: 'Segundo cáncer de piel más común; puede hacer metástasis.',
    detailedDescription: 'Carcinoma de células escamosas. Cáncer de piel que puede ser agresivo y hacer metástasis si no se trata a tiempo.',
    characteristics: ['Crecimiento rápido', 'Ulceración', 'Bordes irregulares', 'Sangrado', 'Costra persistente'],
    recommendations: ['Consulta dermatológica URGENTE', 'Biopsia confirmatoria', 'Estadificación', 'Tratamiento oncológico'],
    urgency: 'urgent',
    color: 'text-red-600',
    bgColor: 'bg-red-50',
    borderColor: 'border-red-200',
